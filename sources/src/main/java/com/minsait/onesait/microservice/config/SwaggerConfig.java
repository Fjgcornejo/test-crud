...
public class SwaggerConfig {
	...
	public Docket restaurantApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.produces(new HashSet<>(Arrays.asList(APP_JSON, TEXT_PL, APP_YAML))).groupName("TestCrud-api")
				.select().apis(RequestHandlerSelectors.basePackage(REST_BASE_PACKAGE)).paths(regex("/TestCrud.*"))
